...
class TestHierarchicalRFCanPredict(unittest.TestCase):
    ...
    def test_can_predict_true(self):
        ...
        data_for_test = mock.MagicMock()
        data_for_test.features.return_value = self.test_features
        data_for_test.detections.return_value = test_detections
    ...
    def test_can_precit_false(self):
        ...
        data_for_test = mock.MagicMock()
        data_for_test.features.return_value = pd.DataFrame()
        data_for_test.detections.return_value = test_detections
        ...
        data_for_test = mock.MagicMock()
        data_for_test.features.return_value = pd.DataFrame()
        data_for_test.detections.return_value = pd.DataFrame()
